...
class QRDraw
{
	public:
		...
		void setup(const char *filename, int modulesize, int symbolsize){
	...
	protected:
		...
		const char *filename;		// 保存するファイル名

	public:
		virtual int draw(const char *filename, int modulesize, int symbolsize, 
